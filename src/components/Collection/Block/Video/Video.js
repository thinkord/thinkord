export default class Video {
    ...
    render() {
        this.wrapper = this.make("video", "video-block", { controls: "" });
        const source = this.make("source");

        this.wrapper.appendChild(source);

        source.src = this.data && this.data.url ? this.data.url : "";
